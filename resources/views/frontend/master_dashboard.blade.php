...
<body class="max-w-7xl m-auto">
  ...
  @include('frontend.body.footer')
    ...
    <!-- Vendor JS-->
    {{--  new dashboard  --}}
    <script src="{{asset('frontend2/js/slider.js') }}"></script>
    <script src="{{asset('frontend2/js/showcase.js') }}"></script>
    <script src="{{asset('frontend2/js/headline.js') }}"></script>
    <script src="{{asset('frontend2/js/modal.js') }}"></script>
    <script src="{{asset('frontend2/js/sidebar.js') }}"></script>
    <script src="{{asset('frontend2/js/quickview.js') }}"></script>
